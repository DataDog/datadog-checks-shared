...
def py3(check):
    """Verify if a custom check or integration can run on python 3.
    CHECK must be a valid path to a Python module or package folder.
    """

    path_to_module = os.path.realpath(check)
